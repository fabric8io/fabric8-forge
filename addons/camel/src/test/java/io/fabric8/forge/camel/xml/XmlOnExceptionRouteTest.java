...
public class XmlOnExceptionRouteTest {
    ...
    public void testXml() throws Exception {
        ...
        InputStream is = new FileInputStream("src/test/resources/io/fabric8/forge/camel/xml/mycamel-onexception.xml");
        String fqn = "src/test/resources/io/fabric8/forge/camel/xml/mycamel-onexception.xml";
