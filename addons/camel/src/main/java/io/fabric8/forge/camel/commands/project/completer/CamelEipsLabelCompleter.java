...
public class CamelEipsLabelCompleter implements UICompleter<String> {

    private final Project project;
    private final CamelCatalog camelCatalog;
    private final Dependency core;

    public CamelEipsLabelCompleter(Project project, CamelCatalog camelCatalog) {
    ...
    public Iterable<String> getValueChoices() {
        // find all available component labels
        Set<String> names = camelCatalog.findModelLabels();
        names.add("<all>");
        return names;
    }
